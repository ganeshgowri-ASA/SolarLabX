...
const complianceMatrix: ComplianceRow[] = [
  {
    ...
    clauses: [
      ...
      { clause: "MQT 02", title: "Maximum Power Determination", status: "covered" },
      { clause: "MQT 03", title: "Insulation Test", status: "covered" },
      { clause: "MQT 06", title: "Performance at STC", status: "covered" },
      { clause: "MQT 11", title: "Thermal Cycling TC200", status: "covered" },
      { clause: "MQT 12", title: "Humidity Freeze", status: "covered" },
      { clause: "MQT 13", title: "Damp Heat DH1000", status: "covered" },
      { clause: "MQT 15", title: "Hot-spot Endurance", status: "partial" },
      { clause: "MQT 16", title: "Mechanical Load", status: "covered" },
      { clause: "MQT 17", title: "Hail Test", status: "covered" },
      { clause: "MQT 19", title: "Bypass Diode Test", status: "not_covered" },
    ],
  },
  {
    ...
    clauses: [
      ...
      { clause: "MST 11", title: "Accessibility Test", status: "covered" },
      { clause: "MST 13", title: "Ground Continuity", status: "covered" },
      { clause: "MST 14", title: "Impulse Voltage", status: "covered" },
      { clause: "MST 16", title: "Insulation Resistance", status: "covered" },
      { clause: "MST 17", title: "Wet Leakage Current", status: "covered" },
      { clause: "MST 21", title: "Temperature Test", status: "covered" },
      { clause: "MST 25", title: "Reverse Current Overload", status: "not_covered" },
      { clause: "MST 26", title: "Module Breakage", status: "partial" },
    ],
  },
  {
    ...
    clauses: [
      { clause: "7.1", title: "Power Rating at STC", status: "covered" },
      { clause: "7.2", title: "Power at NMOT", status: "covered" },
      { clause: "7.3", title: "Power at Low Irradiance", status: "covered" },
      { clause: "11", title: "Temperature Coefficients", status: "covered" },
      { clause: "8", title: "Spectral Response", status: "partial" },
      { clause: "9", title: "Angular Response", status: "not_covered" },
    ],
  },
  {
    standard: "IEC 60904",
