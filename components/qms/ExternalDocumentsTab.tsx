...
const EXTERNAL_DOCUMENTS: ExternalDocument[] = [
  ...
  {
    id: "EXT-015",
    title: "General Criteria for Accreditation of Testing and Calibration Laboratories (based on ISO/IEC 17025)",
    standardNumber: "NABL 112",
    edition: "Issue 9",
    year: 2023,
    amendmentStatus: "No amendments",
    ...
    changeHistory: [
      { date: "2023-04-01", action: "First Receipt", by: "Dr. Meera Patel", notes: "Issue 9 received. Replaced Issue 8." },
      { date: "2025-04-01", action: "Annual Review", by: "Dr. Meera Patel", notes: "Confirmed current." },
    ],
  },
  {
    id: "EXT-016",
    title: "Specific Criteria for Accreditation of Testing Laboratories — Electrical Testing",
    standardNumber: "NABL 113",
    edition: "Issue 4",
    year: 2022,
    amendmentStatus: "No amendments",
    source: "NABL",
    ...
    clause: "8.3",
    changeHistory: [
      { date: "2022-06-15", action: "First Receipt", by: "Dr. Meera Patel", notes: "Issue 4 received." },
    ],
  },
  {
    id: "EXT-017",
    title: "Proficiency Testing (PT) Participation Policy for Accredited Laboratories",
    standardNumber: "NABL 120",
    edition: "Issue 6",
    year: 2023,
    amendmentStatus: "No amendments",
    source: "NABL",
    ...
    clause: "8.3",
    changeHistory: [
      { date: "2023-03-01", action: "First Receipt", by: "Quality Manager", notes: "Issue 6 received." },
    ],
  },
  {
    id: "EXT-018",
    title: "Measurement Uncertainty Policy (GUM-based) for Testing and Calibration Laboratories",
    standardNumber: "NABL 122",
    edition: "Issue 4",
    year: 2022,
    amendmentStatus: "No amendments",
    source: "NABL",
    ...
    distributionList: ["Quality Manager", "Lab Manager", "Test Engineer"],
    locationPhysical: "QMS Cabinet – Shelf C3 (NABL File)",
    locationDigital: "SharePoint/ExternalStandards/NABL",
    status: "Current",
    clause: "8.3",
    changeHistory: [
      { date: "2022-05-01", action: "First Receipt", by: "Quality Manager", notes: "Issue 4 received." },
    ],
  },
  {
    id: "EXT-019",
    title: "NABL Logo Usage Policy for Accredited Laboratories",
    standardNumber: "NABL 131",
    edition: "Issue 5",
    year: 2021,
    amendmentStatus: "No amendments",
    source: "NABL",
    ...
    distributionList: ["Quality Manager", "Lab Director"],
    locationPhysical: "QMS Cabinet – Shelf C3 (NABL File)",
    locationDigital: "SharePoint/ExternalStandards/NABL",
    status: "Current",
    clause: "8.3",
    changeHistory: [
      { date: "2021-08-01", action: "First Receipt", by: "Quality Manager", notes: "Issue 5 received." },
    ],
  },
  {
    id: "EXT-020",
    title: "NABL Assessment Procedure for Testing and Calibration Laboratories",
    standardNumber: "NABL 132",
    edition: "Issue 7",
    year: 2023,
    amendmentStatus: "No amendments",
    source: "NABL",
    ...
    clause: "8.3",
    changeHistory: [
      { date: "2023-02-01", action: "First Receipt", by: "Dr. Meera Patel", notes: "Issue 7 received." },
    ],
  },
  {
    id: "EXT-021",
    title: "Internal Audit Guidelines for Accredited Testing Laboratories",
    standardNumber: "NABL 133",
    edition: "Issue 3",
    year: 2021,
    amendmentStatus: "No amendments",
    source: "NABL",
    ...
    reviewDate: "2025-09-01",
    nextReviewDate: "2026-09-01",
    distributionList: ["Quality Manager", "Lead Auditor"],
    locationPhysical: "QMS Cabinet – Shelf C3 (NABL File)",
    locationDigital: "SharePoint/ExternalStandards/NABL",
    status: "Current",
    clause: "8.3",
    changeHistory: [
      { date: "2021-09-01", action: "First Receipt", by: "Quality Manager", notes: "Issue 3 received." },
    ],
  },
  {
    id: "EXT-022",
    title: "Policy on Traceability of Measurements for Accredited Laboratories",
    standardNumber: "NABL 136",
    edition: "Issue 5",
    year: 2022,
    amendmentStatus: "No amendments",
    source: "NABL",
    dateReceived: "2022-04-01",
    reviewedBy: "Quality Manager",
    reviewDate: "2025-04-01",
    nextReviewDate: "2026-04-01",
    distributionList: ["Quality Manager", "Equipment Manager"],
    locationPhysical: "QMS Cabinet – Shelf C3 (NABL File)",
    locationDigital: "SharePoint/ExternalStandards/NABL",
    status: "Current",
    clause: "8.3",
    changeHistory: [
      { date: "2022-04-01", action: "First Receipt", by: "Quality Manager", notes: "Issue 5 received." },
    ],
  },
  {
    id: "EXT-023",
    title: "Inter Laboratory Comparison (ILC) Policy for Testing Laboratories",
    standardNumber: "NABL 141",
    edition: "Issue 4",
    year: 2022,
    amendmentStatus: "No amendments",
    source: "NABL",
    ...
    clause: "8.3",
    changeHistory: [
      { date: "2022-07-01", action: "First Receipt", by: "Quality Manager", notes: "Issue 4 received." },
    ],
  },
  {
    id: "EXT-024",
    title: "ILAC MRA Mark Usage Policy for Accredited Bodies",
    standardNumber: "NABL 160",
    edition: "Issue 3",
    year: 2021,
    amendmentStatus: "No amendments",
    source: "NABL",
    ...
    clause: "8.3",
    changeHistory: [
      { date: "2021-10-01", action: "First Receipt", by: "Quality Manager", notes: "Issue 3 received." },
    ],
  },
  {
    id: "EXT-025",
    title: "Complaints and Appeals Policy for Accredited Laboratories",
    standardNumber: "NABL 163",
    edition: "Issue 3",
    year: 2022,
    amendmentStatus: "No amendments",
    source: "NABL",
    ...
    clause: "8.3",
    changeHistory: [
      { date: "2022-01-15", action: "First Receipt", by: "Quality Manager", notes: "Issue 3 received." },
    ],
  },
  // ─── BIS Guidelines ───────────────────────────────────────────────────────────
  {
    id: "EXT-026",
    title: "Crystalline Silicon Terrestrial Photovoltaic (PV) Modules — Specification",
    standardNumber: "IS 14286",
    edition: "Ed.3",
    year: 2020,
    amendmentStatus: "No amendments",
    ...
    nextReviewDate: "2026-06-01",
    distributionList: ["Lab Manager", "Test Engineer", "Quality Manager"],
    locationPhysical: "QMS Cabinet – Shelf D1 (BIS File)",
    locationDigital: "SharePoint/ExternalStandards/BIS",
    status: "Current",
    clause: "8.3",
    changeHistory: [
      { date: "2020-06-01", action: "First Receipt", by: "Priya Sharma", notes: "Ed.3 received from BIS." },
    ],
  },
  {
    id: "EXT-027",
    title: "Thin-film Terrestrial Photovoltaic (PV) Modules — Specification",
    standardNumber: "IS 16077",
    edition: "Ed.2",
    year: 2019,
    amendmentStatus: "No amendments",
    source: "BIS",
    ...
    clause: "8.3",
    changeHistory: [
      { date: "2019-11-01", action: "First Receipt", by: "Priya Sharma", notes: "Ed.2 received from BIS." },
    ],
  },
  {
    id: "EXT-028",
    title: "Lab Recognition Scheme (LRS) for BIS — Testing Laboratory Requirements",
    standardNumber: "LRS 2020",
    edition: "Rev.1",
    year: 2020,
    amendmentStatus: "Amendment 1 (2022) incorporated",
    source: "BIS",
    ...
    clause: "8.3",
    changeHistory: [
      { date: "2020-09-01", action: "First Receipt", by: "Dr. Meera Patel", notes: "LRS Rev.1 received." },
      { date: "2022-03-01", action: "Amendment", by: "Dr. Meera Patel", notes: "Amendment 1 incorporated." },
    ],
  },
  {
    id: "EXT-029",
    title: "BIS FMCS Guidelines for Solar PV — Foreign Manufacturers Certification Scheme",
    standardNumber: "BIS FMCS Solar PV",
    edition: "Rev.2",
    year: 2021,
    amendmentStatus: "No amendments",
    source: "BIS",
    ...
    clause: "8.3",
    changeHistory: [
      { date: "2021-04-01", action: "First Receipt", by: "Priya Sharma", notes: "Rev.2 received." },
    ],
  },
  {
    id: "EXT-030",
    title: "BIS CRS Orders for Solar PV — Compulsory Registration Scheme",
    standardNumber: "BIS CRS Solar PV",
    edition: "Rev.3",
    year: 2022,
    amendmentStatus: "No amendments",
    source: "BIS",
    ...
    reviewDate: "2025-02-01",
    nextReviewDate: "2026-02-01",
    distributionList: ["Quality Manager", "Lab Manager", "Lab Director"],
    locationPhysical: "QMS Cabinet – Shelf D1 (BIS File)",
    locationDigital: "SharePoint/ExternalStandards/BIS",
    status: "Current",
    clause: "8.3",
    changeHistory: [
      { date: "2022-02-01", action: "First Receipt", by: "Priya Sharma", notes: "Rev.3 received." },
    ],
  },
  // ─── IEC/IECEE/CTL ─────────────────────────────────────────────────────────────
  {
    id: "EXT-031",
    title: "IECEE Operational Document — CB Scheme Rules of Procedure",
    standardNumber: "IECEE OD-2020",
    edition: "Ed.5",
    year: 2023,
    amendmentStatus: "No amendments",
    source: "IEC",
    ...
    nextReviewDate: "2026-06-01",
    distributionList: ["Lab Director", "Quality Manager", "Lab Manager"],
    locationPhysical: "QMS Cabinet – Shelf A4 (IECEE File)",
    locationDigital: "SharePoint/ExternalStandards/IECEE",
    status: "Current",
    clause: "8.3",
    changeHistory: [
      { date: "2023-06-01", action: "First Receipt", by: "Dr. Meera Patel", notes: "Ed.5 received." },
    ],
  },
  {
    id: "EXT-032",
    title: "IECEE Operational Document — Rules for CB Testing Laboratories (CBTL)",
    standardNumber: "IECEE OD-2041",
    edition: "Ed.4",
    year: 2022,
    amendmentStatus: "No amendments",
    source: "IEC",
    ...
    clause: "8.3",
    changeHistory: [
      { date: "2022-09-01", action: "First Receipt", by: "Dr. Meera Patel", notes: "Ed.4 received." },
    ],
  },
  {
    id: "EXT-033",
    title: "IECEE Operational Document — CTL Decision Sheets Index",
    standardNumber: "IECEE OD-2043",
    edition: "Ed.3",
    year: 2023,
    amendmentStatus: "Updated quarterly",
    source: "IEC",
    ...
    distributionList: ["Lab Manager", "Test Engineer", "Quality Manager"],
    locationPhysical: "QMS Cabinet – Shelf A4 (IECEE File)",
    locationDigital: "SharePoint/ExternalStandards/IECEE/CTL",
    status: "Current",
    clause: "8.3",
    changeHistory: [
      { date: "2023-01-15", action: "First Receipt", by: "Anil Mehta", notes: "Ed.3 received. Index of all CTL DSH." },
    ],
  },
  {
    id: "EXT-034",
    title: "CTL Decision Sheet — PV Module Additional Test Requirements",
    standardNumber: "CTL DSH 1927",
    edition: "Rev.4",
    year: 2023,
    amendmentStatus: "No amendments",
    source: "IEC",
    ...
    nextReviewDate: "2026-04-01",
    distributionList: ["Test Engineer", "Lab Manager"],
    locationPhysical: "QMS Cabinet – Shelf A4 (CTL File)",
    locationDigital: "SharePoint/ExternalStandards/IECEE/CTL",
    status: "Current",
    clause: "8.3",
    changeHistory: [
      { date: "2023-04-01", action: "First Receipt", by: "Anil Mehta", notes: "Rev.4 received." },
    ],
  },
  {
    id: "EXT-035",
    title: "CTL Decision Sheet — Bypass Diode Testing Requirements for PV Modules",
    standardNumber: "CTL DSH 1929",
    edition: "Rev.3",
    year: 2022,
    amendmentStatus: "No amendments",
    source: "IEC",
    ...
    clause: "8.3",
    changeHistory: [
      { date: "2022-06-01", action: "First Receipt", by: "Anil Mehta", notes: "Rev.3 received." },
    ],
  },
  {
    id: "EXT-036",
    title: "CTL Decision Sheet — Bifacial PV Module Testing Requirements",
    standardNumber: "CTL DSH 1946",
    edition: "Rev.2",
    year: 2023,
    amendmentStatus: "No amendments",
    source: "IEC",
    ...
    reviewDate: "2025-07-01",
    nextReviewDate: "2026-07-01",
    distributionList: ["Test Engineer", "Lab Manager", "Data Analyst"],
    locationPhysical: "QMS Cabinet – Shelf A4 (CTL File)",
    locationDigital: "SharePoint/ExternalStandards/IECEE/CTL",
    status: "Current",
    clause: "8.3",
    changeHistory: [
      { date: "2023-07-01", action: "First Receipt", by: "Anil Mehta", notes: "Rev.2 received. Bifacial testing clarifications." },
    ],
  },
  {
    id: "EXT-037",
    title: "Terrestrial PV modules — Design qualification and type approval (All Parts: 61215-1, 61215-1-1 to 1-4, 61215-2)",
    standardNumber: "IEC 61215 Series",
    edition: "Ed.2",
    year: 2021,
    amendmentStatus: "Amendment 1 (2023) incorporated",
    source: "IEC",
    ...
    distributionList: ["Lab Manager", "Test Engineer", "Quality Manager", "Data Analyst"],
    locationPhysical: "QMS Cabinet – Shelf A1",
    locationDigital: "SharePoint/ExternalStandards/IEC61215",
    status: "Current",
    clause: "8.3",
    changeHistory: [
      { date: "2021-07-15", action: "First Receipt", by: "Dr. Meera Patel", notes: "Full series Ed.2 received." },
      { date: "2023-05-20", action: "Amendment", by: "Priya Sharma", notes: "Amendment 1 incorporated." },
    ],
  },
  {
    id: "EXT-038",
    title: "PV module safety qualification (All Parts: 61730-1, 61730-2)",
    standardNumber: "IEC 61730 Series",
    edition: "Ed.2",
    year: 2023,
    amendmentStatus: "No amendments",
    source: "IEC",
    ...
    clause: "8.3",
    changeHistory: [
      { date: "2023-10-01", action: "First Receipt", by: "Dr. Meera Patel", notes: "Full series Ed.2 received." },
    ],
  },
  {
    id: "EXT-039",
    title: "System voltage durability test for crystalline silicon modules — Detection of potential-induced degradation",
    standardNumber: "IEC 62804",
    edition: "Ed.1",
    year: 2015,
    amendmentStatus: "Amendment 1 (2020)",
    source: "IEC",
    ...
    distributionList: ["Test Engineer", "Lab Manager"],
    locationPhysical: "QMS Cabinet – Shelf B3",
    locationDigital: "SharePoint/ExternalStandards/IEC62804",
    status: "Current",
    clause: "8.3",
    changeHistory: [
      { date: "2015-11-01", action: "First Receipt", by: "Raj Krishnan", notes: "Ed.1 received." },
      { date: "2020-06-01", action: "Amendment", by: "Raj Krishnan", notes: "Amendment 1 incorporated." },
    ],
  },
  {
    id: "EXT-040",
    title: "Test procedures for materials used in PV modules — Polymeric materials testing (All Parts)",
    standardNumber: "IEC 62788 Series",
    edition: "Ed.1",
    year: 2017,
    amendmentStatus: "No amendments",
    source: "IEC",
    ...
    clause: "8.3",
    changeHistory: [
      { date: "2017-12-01", action: "First Receipt", by: "Raj Krishnan", notes: "Series received." },
    ],
  },
  {
    id: "EXT-041",
    title: "Photovoltaic devices — All Parts (60904-1 to 60904-9): I-V Measurement, Spectral Response, Reference Devices, Simulator Classification",
    standardNumber: "IEC 60904 Series",
    edition: "Ed.3",
    year: 2020,
    amendmentStatus: "No amendments",
    source: "IEC",
    ...
    clause: "8.3",
    changeHistory: [
      { date: "2020-11-05", action: "First Receipt", by: "Anil Mehta", notes: "Full series Ed.3 received." },
    ],
  },
  {
    id: "EXT-042",
    title: "PV module performance testing and energy rating (All Parts: 61853-1 to 61853-4)",
    standardNumber: "IEC 61853 Series",
    edition: "Ed.1",
    year: 2011,
    amendmentStatus: "Part 3 & 4 added (2018)",
    source: "IEC",
    dateReceived: "2012-06-01",
    reviewedBy: "Raj Krishnan",
    reviewDate: "2025-06-01",
    ...
    clause: "8.3",
    changeHistory: [
      { date: "2012-06-01", action: "First Receipt", by: "Raj Krishnan", notes: "Part 1 received." },
      { date: "2018-09-01", action: "Update", by: "Raj Krishnan", notes: "Parts 3 & 4 added to collection." },
    ],
  },
  {
    id: "EXT-043",
    title: "PV modules — Type test retesting, re-certification and type approval extension",
    standardNumber: "IEC 62915",
    edition: "Ed.2",
    year: 2022,
    amendmentStatus: "No amendments",
  ...
  {
    id: "EXT-044",
    title: "Procedures for temperature and irradiance corrections to measured I-V characteristics",
    standardNumber: "IEC 60891",
    edition: "Ed.3",
    year: 2021,
    amendmentStatus: "No amendments",
  ...
  {
    id: "EXT-045",
    title: "Extended-stress testing of PV modules",
    standardNumber: "IEC TS 63209",
    edition: "Ed.1",
    year: 2022,
    amendmentStatus: "No amendments",
    source: "IEC",
    ...
    nextReviewDate: "2026-12-01",
    distributionList: ["Test Engineer", "Lab Manager"],
    locationPhysical: "QMS Cabinet – Shelf B4",
    locationDigital: "SharePoint/ExternalStandards/IEC63209",
    status: "Current",
    clause: "8.3",
    changeHistory: [
      { date: "2022-12-01", action: "First Receipt", by: "Raj Krishnan", notes: "Ed.1 received. Technical specification." },
    ],
  },
  {
    id: "EXT-046",
    title: "Guidelines for qualifying PV modules, components and materials for operation at high temperatures",
    standardNumber: "IEC TS 63126",
    edition: "Ed.1",
    year: 2020,
    amendmentStatus: "No amendments",
    source: "IEC",
    dateReceived: "2020-08-01",
    reviewedBy: "Raj Krishnan",
    reviewDate: "2025-08-01",
    nextReviewDate: "2026-08-01",
    distributionList: ["Test Engineer", "Lab Manager"],
    locationPhysical: "QMS Cabinet – Shelf B4",
    locationDigital: "SharePoint/ExternalStandards/IEC63126",
    status: "Current",
    clause: "8.3",
    changeHistory: [
      { date: "2020-08-01", action: "First Receipt", by: "Raj Krishnan", notes: "Ed.1 received. Hot climate testing guidance." },
    ],
  },
  {
    id: "EXT-047",
    title: "Salt mist corrosion testing of photovoltaic (PV) modules",
    standardNumber: "IEC 61701",
    edition: "Ed.2",
    year: 2020,
    amendmentStatus: "No amendments",
    source: "IEC",
    dateReceived: "2020-05-01",
    reviewedBy: "Raj Krishnan",
    reviewDate: "2025-05-01",
    nextReviewDate: "2026-05-01",
    distributionList: ["Test Engineer", "Lab Manager"],
    locationPhysical: "QMS Cabinet – Shelf B4",
    locationDigital: "SharePoint/ExternalStandards/IEC61701",
    status: "Current",
    clause: "8.3",
    changeHistory: [
      { date: "2020-05-01", action: "First Receipt", by: "Raj Krishnan", notes: "Ed.2 received." },
    ],
  },
  {
    id: "EXT-048",
    title: "Ammonia (NH3) corrosion testing of photovoltaic (PV) modules",
    standardNumber: "IEC 62716",
    edition: "Ed.1",
    year: 2013,
    amendmentStatus: "No amendments",
    source: "IEC",
    dateReceived: "2014-02-01",
    reviewedBy: "Raj Krishnan",
    reviewDate: "2025-02-01",
    nextReviewDate: "2026-02-01",
    distributionList: ["Test Engineer", "Lab Manager"],
    locationPhysical: "QMS Cabinet – Shelf B4",
    locationDigital: "SharePoint/ExternalStandards/IEC62716",
    status: "Current",
    clause: "8.3",
    changeHistory: [
      { date: "2014-02-01", action: "First Receipt", by: "Raj Krishnan", notes: "Ed.1 received." },
    ],
  },
];
